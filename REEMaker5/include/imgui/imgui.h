...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorMonoChrome(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorBlackWhite(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsDark(ImGuiStyle* dst = NULL);    // new, recommended style (default)
    IMGUI_API void          StyleColorsLight(ImGuiStyle* dst = NULL);   // best used with borders and a custom, thicker font
    IMGUI_API void          StyleColorsClassic(ImGuiStyle* dst = NULL); // classic imgui style
    IMGUI_API void          StyleColorsDarkCharcoal(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsCorporateGrey(bool is3D = false, ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsGoldBlack(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsVSLike(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsRedDark(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsDarkGreen(ImGuiStyle* dst = NULL);
